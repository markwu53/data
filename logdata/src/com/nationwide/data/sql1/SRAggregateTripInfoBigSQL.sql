--------------------   Trip Info table Creation -------------------------

drop table MarkSR.sr_trip_minute_aggregates;

Create table MarkSR.sr_trip_minute_aggregates
...
from MarkSR.sr_scrubbed_latest
)
...
select * from MarkSR.sr_trip_minute_aggregates;
select count(*) from MarkSR.sr_trip_minute_aggregates;

drop table MarkSR.sr_trip_info;

Create table MarkSR.sr_trip_info
...
from MarkSR.sr_trip_minute_aggregates 
group by trip_number
)
select 
substr(trip_number, 1, 7) as trip_number,
substr(trip_number, 8) as vin_number, 
...
select * from MarkSR.sr_trip_info;
select count(*) from MarkSR.sr_trip_info;
