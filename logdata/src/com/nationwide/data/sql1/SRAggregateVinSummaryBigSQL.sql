----- One time execution -----
Create table MarkSR.sr_vin_summary
(vin_number string, period_flg char(1), period char(10), 
miles double, miles_delta double, night_time double, night_time_delta double, 
accel_count integer, accel_count_delta integer, hard_break_count integer, hard_break_count_delta integer
)
row format delimited fields terminated by ','

---- Continuous execution --------

drop table MarkSR.sr_vin_summary_latest;

Create table MarkSR.sr_vin_summary_latest
...
from vin_all_summary as l full outer join MarkSR.sr_vin_summary c
on 
...
select * from MarkSR.sr_vin_summary_latest;
select count(*) from MarkSR.sr_vin_summary_latest;

drop table MarkSR.sr_vin_summary;

alter table MarkSR.sr_vin_summary_latest rename to MarkSR.sr_vin_summary;
